const global = {
  ...
  api: {
    apiKey: '2412cb11831b1a4505e3daf1fb075ce6',
    ...
    div.innerHTML = `
      ...
      <div class="details-bottom">
        ...
        <ul>
          ...
          <li><span class="text-secondary">Country:</span> ${show.origin_country}</li>
...
function dispalySearchResults(results) {
  ...
  results.forEach((result) => {
    ...
    document.querySelector('#search-results-heading').innerHTML =`
            <h2>${results.length * global.search.page} of ${global.search.totalResults} Results for ${global.search.term}</h2>
    `;
